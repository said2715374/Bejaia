...
export default function Apropos() {
    return (
        <div className={styles.Apropos}>
            <Helmet>
                <title>À propos de Bejaia - Découvrez l'histoire, la culture et la modernité</title>
                <meta name="description" content="Explorez l'histoire riche, la culture vibrante et la modernité de Bejaia, une ville sur la côte méditerranéenne de l'Algérie." />
